...
python train_dnn/run_algs.py env=MultiGoals2D_2-v0 alg=bc

python train_dnn/run_algs.py env=MultiGoals2D_3-v0 alg=bc

python train_dnn/run_algs.py env=MultiGoals2D_4-v0 alg=bc

python train_dnn/run_algs.py env=MultiGoals2D_5-v0 alg=bc